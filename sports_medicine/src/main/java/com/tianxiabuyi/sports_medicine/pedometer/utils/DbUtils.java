package com.tianxiabuyi.sports_medicine.pedometer.utils;
...
public class DbUtils {
     ...
     * @return
     */
    public static <T> List<T> getQueryByWhere(Class<T> cla, String field1, String[] value1, String field2, Integer[] value2) {
        return liteOrm.<T>query(new QueryBuilder(cla).where(field1 + "=?", value1).whereAnd(field2 + "=?", value2));
    }

    public static <T> List<T> getQueryByWhere(Class<T> cla, String field1, String[] value1) {
        return liteOrm.<T>query(new QueryBuilder(cla).where(field1 + "=?", value1));
    }
