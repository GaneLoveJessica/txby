...
public class ToastTool {
    ...
    public static void show(Context context, Object obj) {
        ...
        if (listener != null) {
            listener.onToast(Tools.Object2String(context, obj));
        }
    }

    public static void init(OnToastListener listener) {
        ToastTool.listener = listener;
    }

    private static OnToastListener listener;
